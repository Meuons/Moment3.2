...
namespace Moment3._2.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsersId,Name")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("UsersId,Name")] Users users)
        {
            if (id != users.UsersId)
            {
                return NotFound();
